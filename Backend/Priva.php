...
<body>
  ...
  <div class="header">
    ...
    <nav class="nav">
      ...
      <a href="BuyerShopPage.php">PRODUCT</a>
      <a href="BuyerHomePage.php">ABOUT</a>
      <a href="BuyerContactPage.php">CONTACT</a>
    </nav>
  </div>
  ...
  <footer class="footer">
    <p>
      ...
      <a href="TC.php" class="footer-link">Terms & Conditions</a>
    </p>
    <div>
      Follow us on:
